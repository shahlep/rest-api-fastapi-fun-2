...
from .. import databases, models as _models, schemas as _schemas, oauth
...
def all_blog(db: Session = Depends(get_db), get_current_user: _schemas.User = Depends(oauth.get_current_user)):
